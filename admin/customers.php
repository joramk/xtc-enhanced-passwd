...
require_once (DIR_FS_CATALOG.DIR_WS_CLASSES.'encryption_wrapper.php');
...
// New VAT CHECK END
			...
			*/
			...
			if ($error == false) {
				...
				if ($password != "") {			
					$sql_data_array=array_merge($sql_data_array,array('customers_password' => xtc_encryption_wrapper::createHash($password)));						
				}
