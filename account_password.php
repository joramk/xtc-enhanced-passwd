...
if (isset ($_POST['action']) && ($_POST['action'] == 'process')) {
	...
	if ($error == false) {
		...
		if (xtc_encryption_wrapper::validatePassword($password_current, $check_customer['customers_password'])) {
			xtc_db_query("UPDATE ".TABLE_CUSTOMERS." SET customers_password = '".xtc_encryption_wrapper::createHash($password_new)."', customers_last_modified=now() WHERE customers_id = '".(int) $_SESSION['customer_id']."'");
